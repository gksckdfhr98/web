...
! function(e, t, n) {
    ...
    function l(e, n, i, o) {
        var r, l, d, f, u = "modernizr",
            c = s("div"),
            p = a();
        if (parseInt(i, 10))
            for (; i--;) d = s("div"), d.id = o ? o[i] : u + (i + 1), c.appendChild(d);
    ...
    function h(e, t, o, r) {
        ...
        for (p = e.length, c = 0; p > c; c++)
            if (h = e[c], g = A.style[h], d(h, "-") && (h = f(h)), A.style[h] !== n) {
    ...
    }), Modernizr.addTest("json", "JSON" in e && "parse" in JSON && "stringify" in JSON), Modernizr.addTest("queryselector", "querySelector" in t && "querySelectorAll" in t), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), Modernizr.addTest("atobbtoa", "atob" in e && "btoa" in e, {
        aliases: ["atob-btoa"]
    });
    ...
    var N = "Moz O ms Webkit",
        E = x._config.usePrefixes ? N.split(" ") : [];
    x._cssomPrefixes = E;
