...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/swipper.css">
                           ...
                           <c:forEach items="${list}" var="list">
                               <div class="swiper-slide">
                                   <div class="poster">
                                       ...
                                       <div class="rank"><strong>${list.rank}</strong></div>
                                       <div class="mx">
        ...
        <div class="container">
            <div class="row">
                <div class="new">
                    <h2><em>새로운 영화</em></h2>
                    <div class="new_left">
                        <div class="play" id="showTrailer" data-youtube="R5sTnuMODDw">
                    ...
                    <div class="new_right">
                        ...
                        <span class="release">xxxx년 xx월 xx일 개봉</span>
                        <div class="star">
                    ...
                    <article class="help_box2">
                        ...
                        <div class="card">
                            <ul>
                                <li>
                                    <a href="#">
                                        <span><img src="/resources/images/tcard.png" srcset="/resources/images/tcard@2.jpg 2x" alt="tcard"></span>
                                ...
                                <li>
                                    <a href="#">
                                        <span><img src="/resources/images/lgcard.png" srcset="/resources/images/lgcard@2.png 2x" alt="lgcard"></span>
                                        <strong>LG U+</strong>
                                        <em>영화 2,000원 현장 즉시 할인(1일 5매)</em>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span><img src="/resources/images/kbcard.png" srcset="/resources/images/kbcard@2.png 2x" alt="kbcard "></span>
                                        <strong>KB카드 일반</strong>
                                        <em>영화 2,000원 현장 즉시 할인(1일 5매)</em>
                                    </a>
                                </li>
                            </ul>
