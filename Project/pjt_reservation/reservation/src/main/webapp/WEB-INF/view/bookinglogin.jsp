...
<html lang="ko" class="no-js" >
   ...
   <body class="biz  ko" >
         ...
         <div class="_view_content" ui-view="content" id="container" >
            <booked-confirm>
               <div class="booking_login">
                  ...
                  <!---->
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="${pageContext.request.contextPath}/myreservation" method="post">
                        <h2 class="login_header_sub border_bottom"> <span translate="CM-NON_MEMBER_BK_CONFIRMATION">예약확인</span> </h2>
                        <div class="login_form"> 
                           <label class="label_form" for="resrv_id" translate="CM-BOOKING_NUMBER">예약자 이메일 입력</label> 
                           <input type="text" class="login_input ng-pristine ng-untouched ng-valid ng-empty" id="resrv_id" name="resrv_email" aria-invalid="false" title="예매자이메일">  </div>
                        <button type="submit" form="form1" class="login_btn confirm" id="btn1"> <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!----> 
                     </form>
                  </div>
                  <!----> <!----> 
               </div>
      ...
      <script type="text/javascript" src="./resources/js/bookinglogin.js"></script>
   </body>
</html>